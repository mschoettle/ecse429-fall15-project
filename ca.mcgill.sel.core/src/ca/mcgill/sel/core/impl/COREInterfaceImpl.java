 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.sel.core.impl.COREInterfaceImpl#getSelectable <em>Selectable</em>}</li>
 *   <li>{@link ca.mcgill.sel.core.impl.COREInterfaceImpl#getCustomizable <em>Customizable</em>}</li>
 *   <li>{@link ca.mcgill.sel.core.impl.COREInterfaceImpl#getUsable <em>Usable</em>}</li>
 *   <li>{@link ca.mcgill.sel.core.impl.COREInterfaceImpl#getImpacted <em>Impacted</em>}</li>
 *   <li>{@link ca.mcgill.sel.core.impl.COREInterfaceImpl#getDefaults <em>Defaults</em>}</li>
 * </ul>
 *
 * @generated
 */
public class COREInterfaceImpl extends EObjectImpl implements COREInterface {
     ...
     * @ordered
     */
    protected EList<COREImpactNode> impacted;
     ...
     * @generated
     */
    public EList<COREImpactNode> getImpacted() {
        if (impacted == null) {
            impacted = new EObjectResolvingEList<COREImpactNode>(COREImpactNode.class, this, CorePackage.CORE_INTERFACE__IMPACTED);
        }
        return impacted;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case CorePackage.CORE_INTERFACE__IMPACTED:
                getImpacted().clear();
                getImpacted().addAll((Collection<? extends COREImpactNode>)newValue);
                return;
            case CorePackage.CORE_INTERFACE__DEFAULTS:
                getDefaults().clear();
