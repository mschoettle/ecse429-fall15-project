...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sel.core.COREModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class COREModelElementItemProvider
     ...
     * @generated
     */
    public COREModelElementItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((COREModelElement)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_COREModelElement_type") :
            getString("_UI_COREModelElement_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(COREModelElement.class)) {
