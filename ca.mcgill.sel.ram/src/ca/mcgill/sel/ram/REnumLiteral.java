 ...
 * <ul>
 *   <li>{@link ca.mcgill.sel.ram.REnumLiteral#getEnum <em>Enum</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.mcgill.sel.ram.RamPackage#getREnumLiteral()
 * @model
 * @generated
 */
public interface REnumLiteral extends NamedElement {
     ...
     * It is bidirectional and its opposite is '{@link ca.mcgill.sel.ram.REnum#getLiterals <em>Literals</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see #setEnum(REnum)
     * @see ca.mcgill.sel.ram.RamPackage#getREnumLiteral_Enum()
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.sel.ram.REnumLiteral#getEnum <em>Enum</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
