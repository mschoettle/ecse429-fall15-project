 ...
 * <ul>
 *   <li>{@link ca.mcgill.sel.ram.AspectMessageView#getPointcut <em>Pointcut</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.AspectMessageView#getAdvice <em>Advice</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.mcgill.sel.ram.RamPackage#getAspectMessageView()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='notAffectedBySelf'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot notAffectedBySelf='Tuple {\n\tmessage : String = \'Message View may not be affected by itself\',\n\tstatus : Boolean = not self.affectedBy->includes(self)\n}.status'"
 * @generated
 */
public interface AspectMessageView extends AbstractMessageView, NamedElement {
     ...
     * @see ca.mcgill.sel.ram.RamPackage#getAspectMessageView_Pointcut()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.sel.ram.AspectMessageView#getPointcut <em>Pointcut</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.sel.ram.RamPackage#getAspectMessageView_Advice()
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.sel.ram.AspectMessageView#getAdvice <em>Advice</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
