 ...
 * <ul>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getSendEvent <em>Send Event</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getReceiveEvent <em>Receive Event</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getSignature <em>Signature</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getAssignTo <em>Assign To</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getMessageSort <em>Message Sort</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getReturns <em>Returns</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#isSelfMessage <em>Self Message</em>}</li>
 *   <li>{@link ca.mcgill.sel.ram.impl.MessageImpl#getLocalProperties <em>Local Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends EObjectImpl implements Message {
    ...
    public EList<TemporaryProperty> getLocalProperties() {
        if (localProperties == null) {
            localProperties = new EObjectContainmentEList<TemporaryProperty>(TemporaryProperty.class, this, RamPackage.MESSAGE__LOCAL_PROPERTIES);
        }
