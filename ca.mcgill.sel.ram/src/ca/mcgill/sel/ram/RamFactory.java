...
public interface RamFactory extends EFactory {
     ...
     * @generated
     */
    RamFactory eINSTANCE = ca.mcgill.sel.ram.impl.RamFactoryImpl.init();
    ...
    /**
     * Returns a new object of class '<em>Woven Aspect</em>'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return a new object of class '<em>Woven Aspect</em>'.
     * @generated
     */
    WovenAspect createWovenAspect();
