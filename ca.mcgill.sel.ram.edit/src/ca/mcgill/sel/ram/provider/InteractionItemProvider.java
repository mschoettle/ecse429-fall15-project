...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sel.ram.Interaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(RamPackage.Literals.INTERACTION__LIFELINES);
            childrenFeatures.add(RamPackage.Literals.INTERACTION__MESSAGES);
            childrenFeatures.add(RamPackage.Literals.INTERACTION__PROPERTIES);
            childrenFeatures.add(RamPackage.Literals.INTERACTION__FORMAL_GATES);
        }
    ...
    public String getText(Object object) {
        ...
        String label = interaction.eContainingFeature().getName();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (RamPackage.Literals.INTERACTION__LIFELINES,
                 RamFactory.eINSTANCE.createLifeline()));

        newChildDescriptors.add
            (createChildParameter
                (RamPackage.Literals.INTERACTION__MESSAGES,
                 RamFactory.eINSTANCE.createMessage()));

        newChildDescriptors.add
            (createChildParameter
                (RamPackage.Literals.INTERACTION__PROPERTIES,
                 RamFactory.eINSTANCE.createReference()));

        newChildDescriptors.add
            (createChildParameter
                (RamPackage.Literals.INTERACTION__FORMAL_GATES,
                 RamFactory.eINSTANCE.createGate()));
    }
