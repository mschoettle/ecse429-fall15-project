...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sel.ram.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_State_incomings_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_State_incomings_feature", "_UI_State_type"),
                 RamPackage.Literals.STATE__INCOMINGS,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOutgoingsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_State_outgoings_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_State_outgoings_feature", "_UI_State_type"),
                 RamPackage.Literals.STATE__OUTGOINGS,
                 true,
                 false,
                 true,
                 null,
