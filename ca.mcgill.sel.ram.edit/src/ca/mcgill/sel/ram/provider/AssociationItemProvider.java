...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sel.ram.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider
     ...
     * @generated
     */
    protected void addEndsPropertyDescriptorGen(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Association_ends_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Association_ends_feature", "_UI_Association_type"),
                 RamPackage.Literals.ASSOCIATION__ENDS,
                 true,
                 false,
                 true,
                 null,
        ...
        itemPropertyDescriptors.add(
            new ItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Association_ends_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Association_ends_feature", 
