...
/**
 * This is the item provider adapter for a {@link ca.mcgill.sel.ram.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 RamPackage.Literals.CLASS__ABSTRACT,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(RamPackage.Literals.CLASS__ATTRIBUTES);
        }
    ...
    public String getText(Object object) {
        ...
        if (clazz.getPartiality() == COREPartialityType.PUBLIC) {
            label = "|" + label;
        } else if (clazz.getPartiality() == COREPartialityType.CONCERN) {
            label = "\u00A6" + label;
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ca.mcgill.sel.ram.Class.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (RamPackage.Literals.CLASS__ATTRIBUTES,
