 ...
 * @author vbonnet
 */
public class HorizontalLayoutHorizontallyCentered extends AbstractBaseLayout {
    
    private float padding;
    
    public HorizontalLayoutHorizontallyCentered() {
        this(0);
    }
    
    public HorizontalLayoutHorizontallyCentered(final float padding) {
